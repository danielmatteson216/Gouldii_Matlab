function alphastar = ...
        math693a_finalproject_ZOOM(phi,phiD,a_low,a_high,xk,pk,c1,c2,evalphiInit,evalphiInit_der,funcval)
    
    while ( 1 )
        %call interpolate function
        aj = math693a_finalproject_INTERPOLATE(min(a_low,a_high),max(a_low,a_high),phi,phiD,xk,pk,funcval);
        ...
        if evalphik > (evalphiInit +( c1*aj*evalphiInit_der) ) ||  ...
            ...
            evalphik_der = phiD(aj,xk,pk,funcval);     
