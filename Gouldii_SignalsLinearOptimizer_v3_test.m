...
function [TotalLinearOpt,sigprevious,OptParameterA,OptParameterB,OptParameterC,OptParameterD,OptParameterE,OptParameterF,OptMaxDD,OptNetProfit,OptSharpeRatio,OptAnnualizedReturn,isfirstday,cashonweekendsflag,output]...
    = Gouldii_SignalsLinearOptimizer_v3_test(~, SelectedStrategy, Commission, initialportfolio, StopLoss,Serial_startdate_actual,Serial_enddate_actual,...
...
% this will require some logic i believe!!! why is this needed???  
% will we need to vertcat in the below if statement? do we lose information
% from the previous run if we dont?
            ...
            LinearOptimizerResults2 = LinearOptimizerResults;     
...
%---------------------------------------------------------------------------------
%why do we check whether the k counter is equal to 1??
                         if k == 1
                             LinearOptTemp2 = LinearOptimizerResults2;
                             LinearOptimizerResults2 = LinearOptTemp2;
                         else    
                            LinearOptimizerResults2 = vertcat(LinearOptTemp2,LinearOptimizerResults2);
                            LinearOptTemp2 = LinearOptimizerResults2;
                        end          
            
            LinearOptimizerResults3 = LinearOptimizerResults2;
                         ...
                         if p == 1
                             LinearOptTemp3 = LinearOptimizerResults3;
                             LinearOptimizerResults3 = LinearOptTemp3;
                         else    
                            LinearOptimizerResults3 = vertcat(LinearOptTemp3,LinearOptimizerResults3);
                            LinearOptTemp3 = LinearOptimizerResults3;
                        end          
        
             LinearOptimizerResults4 = LinearOptimizerResults3;       
...
% WHAT IS HAPPENING BELOW???????????????? THIS LINE CAUSING ERROR?
    LinearOptimizerResults = LinearOptimizerResults4;
